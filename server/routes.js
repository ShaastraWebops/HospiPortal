...
module.exports = function(app) {
  ...
  // app.use('/api/hospitality', require('./api/hospitality/hostel'));
  // app.use('/api/hospitality/checkin', require('./api/hospitality/checkin'));
  // app.use('/api/hospitality/room', require('./api/hospitality/room'));
